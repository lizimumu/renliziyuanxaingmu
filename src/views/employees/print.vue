<template>
  ...
  <div class="dashboard-container">
    <el-button v-print="'myPrint'" style="float:right">打印</el-button>
...
<script>
import { getEmployeesInfo as getPersonalDetail, getEmployeesJopInfo as getJobDetail } from '@/api/employees'
